      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg">
            <h4 className="font-medium text-slate-800 mb-2">Patrón Identificado</h4>
            <p className="text-sm text-slate-600">Los miércoles presentan un 15% más de residuos comerciales</p>
          </div>
          <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg">
            <h4 className="font-medium text-slate-800 mb-2">Optimización Sugerida</h4>
            <p className="text-sm text-slate-600">Redistribuir 2 vehículos para rutas de alta demanda</p>
          </div>
          <div className="p-4 bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg">
            <h4 className="font-medium text-slate-800 mb-2">Alerta Predictiva</h4>
            <p className="text-sm text-slate-600">Mantenimiento preventivo recomendado para V-018</p>
          </div>
        </div>
      </div>
    </div>
